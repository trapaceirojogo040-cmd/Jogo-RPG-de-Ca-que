...
def rank_xp(xp):
    ...
    # ⚡ Bolt: Replaced loop with if/elif/else for a significant performance boost.
    # Direct comparison is faster than list iteration for a fixed number of thresholds.
    if xp < 100:
        return 'F'
    elif xp < 500:
        return 'E'
