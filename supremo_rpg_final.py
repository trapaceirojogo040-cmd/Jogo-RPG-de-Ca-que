...
# 🛡️ Sentinel: Carrega as variáveis de ambiente para evitar hardcoding de segredos.
load_dotenv()
...
# 🛡️ Sentinel: A senha base foi movida para variáveis de ambiente para evitar hardcoding.
# Use um arquivo .env para configurar a variável SENHA_BASE.
SENHA_BASE = os.getenv("SENHA_BASE", "default_secret_for_development")
