...
# 🛡️ SENTINEL: Carrega a SENHA_BASE de forma segura a partir das variáveis de ambiente.
# Isso evita que segredos sejam expostos diretamente no código.
SENHA_BASE = os.getenv("SENHA_BASE")
if not SENHA_BASE:
    print("\u001B[91m[FALHA CRÍTICA DE SEGURANÇA] A variável de ambiente SENHA_BASE não está definida. Abortando.\u001B[0m")
    exit(1) # Aborta a execução se o segredo não estiver configurado.
