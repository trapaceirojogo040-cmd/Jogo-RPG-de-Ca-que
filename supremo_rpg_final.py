# =============== ARQUIVO DE CONCEITO: SUPREMO_RPG_AI_X_FINAL.py ===============
...
CARGOS = ['PROPRIETÁRIO', 'Administrador', 'Diretor', 'Mestre de Jogo', 'Moderador', 'Jogador']
...
class Personagem:
    ...
    def agir(self, acao: str, alvo=None):
        ...
        return frase_log(self, f"ação {acao} foi executada (simulada)", True)
    ...
    def validar_operacao_militar(self, emissor: Personagem, acao: str, codigo_inserido: str, base_militar: 'BaseMilitar') -> bool:
        ...
        if emissor.cargo == 'PROPRIETÁRIO' or codigo_inserido == codigo_esperado:
            ...
            if random.random() > fator_risco:
                ...
                print(frase_log(emissor, f"Operação '{acao}' bem-sucedida! A força bélica aumentou.", True, "\u001B[96m"))
            else:
                base_militar.forca_belica -= 50
                print(frase_log(emissor, f"A operação '{acao}' sofreu perdas. A força bélica diminuiu.", False, "\u001B[91m"))
...
class IA_NPC:
    ...
    def _pontuacao_utilidade(personagem: Personagem, alvo: Personagem) -> Dict[str, float]:
        ...
        # Pontuação de saúde do NPC (0=morto, 1=saudável). A sigmoide faz a pontuação cair drasticamente abaixo de 50%.
        ...
        # Pontuação para EXPLORAR: útil se o NPC está com saúde razoável e não há ameaça imediata.
    ...
    def decidir_acao_npc(self, npc: Personagem, alvo: Personagem) -> str:
        ...
        if scores["cura"] > 0.6: return "cura" # Prioridade alta para cura se a saúde estiver abaixo de ~40%
...
if __name__ == "__main__":
    ...
    print(f"A IA decide para {vilao_inimigo.nome} (PV 15): {decisao.upper()}")
