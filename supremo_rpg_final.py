...
# 🛡️ Sentinel: Carrega a SENHA_BASE de uma variável de ambiente para evitar hardcoding de segredos.
SENHA_BASE = os.getenv("SENHA_BASE")
if not SENHA_BASE:
    raise ValueError("A variável de ambiente SENHA_BASE não está definida. Crie um arquivo .env e adicione a variável.")
