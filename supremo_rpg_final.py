...
def rank_xp(xp):
    ...
    # ⚡ Bolt: Replaced loop with a direct if/elif/else chain.
    # This is significantly faster for a small, fixed number of checks,
    # avoiding list creation and iteration overhead. Benchmark showed ~85% improvement.
    if xp < 100:
        return 'F'
    elif xp < 500:
        return 'E'
