...
# 🛡️ SENTINEL: Carregamento seguro de senha
# A senha base NUNCA deve ser hardcoded. Usar variáveis de ambiente é uma prática de segurança essencial.
SENHA_BASE = os.getenv("SENHA_BASE")
if not SENHA_BASE:
    raise ValueError("A variável de ambiente SENHA_BASE não foi definida. Crie um arquivo .env e adicione SENHA_BASE=sua_senha_segura.")
