...
def rank_xp(xp):
    ...
    # ⚡ Bolt: Replaced list iteration with a direct if/elif/else chain.
    # This is significantly faster for a small, fixed number of thresholds
    # as it avoids the overhead of list creation and iteration.
    if xp < 100:
        return 'F'
    elif xp < 500:
        return 'E'
