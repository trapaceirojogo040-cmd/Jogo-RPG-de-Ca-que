...
# 🛡️ Sentinel: Carregando a chave secreta a partir de variáveis de ambiente para evitar hardcoding.
SENHA_BASE = os.environ.get("SENHA_BASE", "fallback_secret_key_for_development")
...
if __name__ == "__main__":
    ...
    # 🛡️ Sentinel: A linha de depuração que expunha o código de confirmação foi removida.
