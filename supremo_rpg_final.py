...
def rank_xp(xp):
    ...
    # ⚡ Bolt: Replaced loop with if/elif/else for performance.
    # For a small, fixed number of thresholds, a direct conditional check
    # is more efficient than iterating through a list.
    if xp < 100:
        return 'F'
    elif xp < 500:
        return 'E'
