...
# 🛡️ Sentinel: A SENHA_BASE foi movida para variáveis de ambiente (.env) para evitar hardcoding de segredos.
SENHA_BASE = os.getenv("SENHA_BASE")
if not SENHA_BASE:
    print("\u001B[91m[FALHA CRÍTICA DE SEGURANÇA] A variável de ambiente SENHA_BASE não foi definida. Encerrando.\u001B[0m")
    sys.exit(1)
