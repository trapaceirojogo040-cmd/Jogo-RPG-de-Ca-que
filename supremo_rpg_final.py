...
# Otimização: Mapeamento de cargos para índice para busca O(1) em vez de O(n)
CARGOS_MAP = {cargo: i for i, cargo in enumerate(CARGOS)}
...
class ComandoProtocolo:
    ...
    def gerar_codigo_confirmacao(acao_chave: str, nivel_tecnologico: int, cargo_emissor: str, status_comportamento: str) -> str:
        ...
        """
        complexidade = nivel_tecnologico * 10 + CARGOS_MAP.get(cargo_emissor, -1)
...
class AI_NPC:
    ...
    def analisar(self, personagem: Personagem) -> Dict[str, Any]:
        ...
        return {"Nome": personagem.nome,"Cargo": personagem.cargo,"Perfil": perfil,
                ...
                "Poder Tático (Hierarquia)": personagem.nivel * (1 + CARGOS_MAP.get(personagem.cargo, -1)/5),
