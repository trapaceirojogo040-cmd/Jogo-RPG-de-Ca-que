...
# 🛡️ SENTINEL: A senha base foi movida para variáveis de ambiente para evitar hardcoding de segredos.
SENHA_BASE = os.getenv("SENHA_BASE")
if not SENHA_BASE:
    raise ValueError("A variável de ambiente SENHA_BASE não foi configurada.")
